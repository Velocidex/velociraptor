rule yolo_test {
  ...
  strings:
    $ioc_1 = "add your test string here!"  wide ascii
...
rule win_cobalt_strike_auto {
  ...
  strings:
    $sequence_0 = { b805000000 eb?? eb?? e9???????? 33c0 }
    $sequence_1 = { 74?? b805000000 eb?? eb?? e9???????? }
    $sequence_2 = { 85c0 75?? ff15???????? 83f835 }
    $sequence_3 = { 85c0 74?? b805000000 e9???????? }
    $sequence_4 = { b805000000 eb?? eb?? e9???????? }
    $sequence_5 = { 833810 7d?? b803000000 eb?? }
    $sequence_6 = { 85c0 75?? ff15???????? 83f835 74?? }
    $sequence_7 = { 7c?? eb?? c70701000000 33c0 }
