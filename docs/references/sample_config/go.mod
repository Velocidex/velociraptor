...
require (
	...
	www.velocidex.com/golang/velociraptor v0.76.1-rc1.0.20260528000610-1b88e482c1a2
)
...
require (
	...
	www.velocidex.com/golang/vfilter v0.0.0-20260531234105-179ed0495b4a // indirect
)
