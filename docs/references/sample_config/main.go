...
var (
	...
	hidden_fields = []string{
		...
		"Client.Logging",
		"Client.Logging.output_directory",
		"Client.Logging.separate_logs_per_component",
		"Client.Logging.rotation_time",
		"Client.Logging.max_age",
		"Client.Logging.debug",
		"Client.Logging.debug.rotation_time",
		"Client.Logging.debug.max_age",
		"Client.Logging.debug.disabled",
		"Client.Logging.info",
		"Client.Logging.info.rotation_time",
		"Client.Logging.info.max_age",
		"Client.Logging.info.disabled",
		"Client.Logging.error",
		"Client.Logging.error.rotation_time",
		"Client.Logging.error.max_age",
		"Client.Logging.error.disabled",
		"Client.Logging.remote_syslog_server",
		"Client.Logging.remote_syslog_protocol",
		"Client.Logging.remote_syslog_components",
		...
		"GUI.authenticator.disable_email_to_sub_pin",
		...
		"Frontend.resources.client_info_skip_writing_legacy_records",
		...
		"security.client_self_labels_regex",
