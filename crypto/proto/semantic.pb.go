...
func (SemanticDescriptor_Labels) EnumDescriptor() ([]byte, []int) { return fileDescriptor1, []int{0, 0} }
...
func (*SemanticDescriptor) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{0} }
...
func (*SemanticMessageDescriptor) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{1} }
...
func init() { proto1.RegisterFile("semantic.proto", fileDescriptor1) }
