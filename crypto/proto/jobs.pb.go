...
type GrrMessage struct {
	...
	AuthState GrrMessage_AuthorizationState `protobuf:"varint,7,opt,name=auth_state,json=authState,enum=proto.GrrMessage_AuthorizationState" json:"auth_state,omitempty"`
	// The final response to a request carries this type which indicates it is a
	// status message.
	Type            GrrMessage_Type     `protobuf:"varint,8,opt,name=type,enum=proto.GrrMessage_Type" json:"type,omitempty"`
	Priority        GrrMessage_Priority `protobuf:"varint,9,opt,name=priority,enum=proto.GrrMessage_Priority" json:"priority,omitempty"`
	Ttl             uint32              `protobuf:"varint,10,opt,name=ttl" json:"ttl,omitempty"`
	RequireFastpoll bool                `protobuf:"varint,11,opt,name=require_fastpoll,json=requireFastpoll" json:"require_fastpoll,omitempty"`
	CpuLimit        float32             `protobuf:"fixed32,12,opt,name=cpu_limit,json=cpuLimit" json:"cpu_limit,omitempty"`
	...
	TaskTtl int32  `protobuf:"varint,16,opt,name=task_ttl,json=taskTtl" json:"task_ttl,omitempty"`
	...
	NetworkBytesLimit uint64 `protobuf:"varint,21,opt,name=network_bytes_limit,json=networkBytesLimit" json:"network_bytes_limit,omitempty"`
...
type GrrStatus struct {
	Status           GrrStatus_ReturnedStatus `protobuf:"varint,1,opt,name=status,enum=proto.GrrStatus_ReturnedStatus" json:"status,omitempty"`
...
type PackedMessageList struct {
	...
	Compression PackedMessageList_CompressionType `protobuf:"varint,4,opt,name=compression,enum=proto.PackedMessageList_CompressionType" json:"compression,omitempty"`
...
type CipherProperties struct {
	...
	HmacType CipherProperties_HMACType `protobuf:"varint,6,opt,name=hmac_type,json=hmacType,enum=proto.CipherProperties_HMACType" json:"hmac_type,omitempty"`
}
...
type ClientCommunication struct {
	...
	Status     ClientCommunication_Status `protobuf:"varint,5,opt,name=status,enum=proto.ClientCommunication_Status" json:"status,omitempty"`
