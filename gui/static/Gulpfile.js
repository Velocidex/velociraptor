...
gulp.task('compile-third-party-js', function() {
  return gulp.src([config.nodeModulesDir + '/jquery/dist/jquery.js',
                   ...
                   config.nodeModulesDir + '/flot/source/jquery.colorhelpers.js',
                   config.nodeModulesDir + '/flot/dist/es5/jquery.flot.js',
                   config.nodeModulesDir + '/flot/source/jquery.flot.saturated.js',
                   config.nodeModulesDir + '/flot/source/jquery.flot.browser.js',
                   config.nodeModulesDir + '/flot/source/jquery.flot.uiConstants.js',
