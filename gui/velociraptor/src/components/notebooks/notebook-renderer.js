...
export default class NotebookRenderer extends React.Component {
    ...
    upCell = (cell_id) => {
        ...
        for (var i = 0; i < cell_metadata.length; i++) {
            if (cell_metadata[i].cell_id === cell_id && new_cells
                .length > 0) {
    ...
    downCell = (cell_id) => {
        ...
        var new_cells = [];
        for (var i = 0; i < cell_metadata.length; i++) {
            if (cell_metadata[i].cell_id === cell_id && cell_metadata
                .length >
                i) {
    ...
    addCell = (cell_id, cell_type, content, env) => {
        ...
        api.post('v1/NewNotebookCell',
            ...
            .then((response) => {
                ...
                this.props.fetchNotebooks();
                this.setState({
                    selected_cell_id: response.data
                        .latest_cell_id,
                    loading: false
                });
            });
    ...
    render() {
        ...
        return (
                ...
                /> {
                _.map(this.props.notebook.cell_metadata, (cell_md,
                    idx) => {
