...
export class YamlHighlightRules extends window.ace.acequire("ace/mode/yaml_highlight_rules").YamlHighlightRules {
    constructor() {
        ...
        this.$rules["start"] = [{
            token : "keyword",
            regex : /\s*-?\s*(name|type|description|choices|sources|parameters|author|reference|required_permissions|resources|tools|parameters|url|default|serve_locally|github_asset_regex|github_project|column_types|imports|export|notebook|template):/,
        }, {
            token: "keyword",
