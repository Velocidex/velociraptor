...
type ApiFlowRequestDetails struct {
	...
	Items []*proto1.GrrMessage `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
}
...
func (x *ApiFlowRequestDetails) GetItems() []*proto1.GrrMessage {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *ApiFlowResultDetails) GetItems() []*proto1.GrrMessage {
	if x != nil {
		return x.Items
	}
	return nil
...
var file_flows_proto_goTypes = []interface{}{
	...
	(*proto1.GrrMessage)(nil),              // 9: proto.GrrMessage
