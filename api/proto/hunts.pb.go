...
const file_hunts_proto_rawDesc = "" +
	...
	"\x19total_clients_with_errors\x18\x0f \x01(\x04BG\xe2\xfc\xe3\xc4\x01A\x12$Total number of clients with errors.\"\x19Total Clients with ErrorsR\x16totalClientsWithErrors\x120\n" +
	"\x14total_uploaded_bytes\x18\x12 \x01(\x04R\x12totalUploadedBytes\x120\n" +
	"\x14total_collected_rows\x18\x13 \x01(\x04R\x12totalCollectedRows\x124\n" +
	"\x16total_finished_clients\x18\x14 \x01(\x04R\x14totalFinishedClients\x12y\n" +
	...
	"\x13available_downloads\x18\x02 \x01(\v2\x19.proto.AvailableDownloadsR\x12availableDownloads\x123\n" +
	"\x16last_client_table_scan\x18\x11 \x01(\x03R\x13lastClientTableScan\"\xca\v\n" +
	"\x04Hunt\x12(\n" +
